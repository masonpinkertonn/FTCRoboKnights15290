...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static Encoder.Direction leftEncoderDir = Encoder.Direction.REVERSE;
    public static Encoder.Direction rightEncoderDir = Encoder.Direction.REVERSE;
    public static Encoder.Direction frontEncoderDir = Encoder.Direction.FORWARD;
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        ...
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "launch1"));
