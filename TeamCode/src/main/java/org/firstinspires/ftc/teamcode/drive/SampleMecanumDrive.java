...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    //public static Encoder.Direction enc

    public static double LATERAL_MULTIPLIER = 1.485096964;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        leftFront.setDirection(leftFrontDirection);
        leftRear.setDirection(leftBackDirection);
        rightFront.setDirection(rightFrontDirection);
        rightRear.setDirection(rightBackDirection);
